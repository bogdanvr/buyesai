...
CRM_ACT_EXECUTOR_NAME = env("CRM_ACT_EXECUTOR_NAME", default="")
CRM_ACT_EXECUTOR_REQUISITES = env("CRM_ACT_EXECUTOR_REQUISITES", default="")
SONIOX_API_KEY = env("SONIOX_API_KEY", default="")
SONIOX_API_BASE_URL = env("SONIOX_API_BASE_URL", default="https://api.soniox.com/v1")
SONIOX_MODEL_ID = env("SONIOX_MODEL_ID", default="stt-async-v4")
SONIOX_WEBHOOK_SECRET = env("SONIOX_WEBHOOK_SECRET", default="")
SONIOX_LANGUAGE_HINTS = env.list("SONIOX_LANGUAGE_HINTS", default=["ru"])
SONIOX_LANGUAGE_HINTS_STRICT = env.bool("SONIOX_LANGUAGE_HINTS_STRICT", default=True)
